export const Stepper = (props) => {
    ...
    return (
        <div>
            <ol class="relative text-gray-500 border-l border-gray-200 dark:border-gray-700 dark:text-gray-400 ml-5">
                {
                    data.map((item) => {
                        return (
                            <li class="mb-10 ml-6">
                                ...
                                <div className="flex justify-between">
                                    <h3 className="py-1 text-white">{item.url}</h3>
                                    <p className='text-white'>06:23</p>
                                </div>
                            </li>
                        )
                    })
            ...
            <hr className='mt-5' />
            <div className='flex justify-between'>
                <p className="py-3">Session Duration</p>
                <p className="py-3">06:23</p>
            </div>
        </div>
    )
}